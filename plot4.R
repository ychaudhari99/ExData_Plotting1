...
## Divide the plot area 
par(mfrow = c(2,2))

## Plot 1
plot(datetime, plotData$Global_active_power, xlab = "", ylab = "Global Active Power", type = "l")

## Plot 2
plot(datetime, plotData$Voltage, xlab = "datetime", ylab = "Voltage", type = "l")
...
## Plot 4
plot(datetime, plotData$Global_reactive_power, xlab = "datetime", ylab = "Global_reactive_power", type = "l")
